...
impl<'a> Event<'a> {
    ...
    #[doc = r""]
    #[doc = r" Returns `Unknown` if the event type is not recognized, e.g. if it's from an unknown extension"]
    #[doc = r""]
    #[doc = r" # Safety"]
    #[doc = r""]
    ...
    pub unsafe fn from_raw(raw: &'a MaybeUninit<sys::EventDataBuffer>) -> Self {
        let raw = raw.as_ptr();
        unsafe {
            match (raw as *const sys::BaseInStructure).read().ty {
